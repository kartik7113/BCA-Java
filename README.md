...
class assignment {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new assignment("Piyush", 1041, 25000));
        employees.add(new assignment("Parth", 1054, 18000));
        employees.add(new assignment("nava", 113, 30000));
        employees.add(new assignment("rahul", 103, 22000));
